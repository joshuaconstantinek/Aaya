...
public class Commands {
    ...
    public static final String takeApic2 = "foto sekarang";
    public static final String takeApic3 = "buka kamera dan foto";
    ...
    public static final String lowscreenbright4 = "gelap";
    public static final String maxscreenbright = "terangkan layar";
    public static final String maxscreenbright1 = "terang";
    public static final String maxscreenbright2 = "layar cerah";
    public static final String maxscreenbright3 = "ccerahkan layar";
    public static final String maxscreenbright4 = "cerah";
    public static final String balancescreenbright = "cerahkan sedikit layar";
    public static final String balancescreenbright1 = "seimbang";
    public static final String balancescreenbright2 = "tidak gelap tidak terang";
    public static final String RecordVoice = "rekam suara sekarang";
    public static final String RecordVoice1 = "rekaman sekarang";
    public static final String RecordVoice2 = "record sekarang";
    public static final String recordscreen = "rekam layar sekarang";
    public static final String recordscreen1 = "record layar sekarang";
    public static final String recordscreen2 = "langsung record layar";
    public static final String recordscreen3 = "rekam layar";
    ...
    public static final String youtube5 = "nonton YouTube";
    public static final String youtube6 = "youTube.com";
    ...
    public static final String tokopedia5 = "belanja di Tokopedia";
    public static final String tokopedia6 = "ke tokped";
    public static final String tokopedia7 = "tokopedia.com";
    ...
    public static final String bukalapak5 = "bukalapak.com";
    ...
    public static final String yahoo1 = "ke Yahoo";
    public static final String yahoo2 = "web Yahoo";
    public static final String yahoo3 = "website Yahoo";
    public static final String yahoo4 = "Yahoo Mail";
    public static final String yahoo5 = "buka email Yahoo";
    public static final String yahoo6 = "yahoo.com";
    public static final String yahoo7 = "yahoomail.com";
    //end of yahoo command
    //gmail
    public static final String gmail = "beralih ke Gmail";
    public static final String gmail1 = "ke Gmail";
    public static final String gmail2 = "web Gmail";
    public static final String gmail3 = "website Gmail";
    public static final String gmail4 = "buka email Gmail";
    public static final String gmail5 = "gmail.com";
    public static final String gmail6 = "Google Mail";
    //end of more gmail command
    //wikipedia
    public static final String wikipedia = "beralih ke Wikipedia";
    public static final String wikipedia1 = "ke Wikipedia";
    public static final String wikipedia2 = "web Wikipedia";
    public static final String wikipedia3 = "website Wikipedia";
    public static final String wikipedia4 = "lihat Wikipedia";
    public static final String wikipedia5 = "baca Wikipedia";
    public static final String wikipedia6 = "wikipedia.com";
    //end of wikipedia command
    //nonton film
    public static final String movies = "beralih ke web film";
    public static final String movies1 = "ke web nonton film";
    public static final String movies2 = "web nonton film";
    public static final String movies3 = "website nonton film";
    public static final String movies4 = "buka web nonton film";
    public static final String movies5 = "noton film";
    public static final String movies6 = "nonton film online";
    //end of nonton film more command

    //Profiler
    //silent
    public static final String Silent = "mode diam";
    public static final String Silent1 = "mode silent";
    public static final String Silent2 = "silent";
    public static final String Silent3 = "tidak berbunyi";
    //end of silent
    //normal
